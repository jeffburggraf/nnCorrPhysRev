...
%\mysubsection{n-n angular correlation versus neutron energy}
...
Interesting effects are also seen when plotting neutron correlation vs. energy for several different opening angle cuts.
Fig.~\ref{fig:Diff_cut} shows a minimum threshold applied to the absolute difference in the energies of coincident n-n pairs, and Fig.~\ref{fig:Max_cut} shows an upper limit applied to the energy of both coincident neutrons.
...
Furthermore, if one plots the opening angle distributions for the case in which at least one neutron is emitted perpendicular to the incident photon versus the case in which neither neutron is emitted perpendicular to the incident photon (Fig.~\ref{fig:theta_abs_two_neutron}), one sees distinct differences.
