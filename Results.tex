...
Mathematical details of the KDE method used in this work are outlined in reference~\cite{KDE}. 
...
A similar effect appears in the results reported in reference~\cite{Sokolov2010} for the thermal neutron-induced fission of $^{233}$U and $^{235}$U, but not for the spontaneous fission of $^{252}$Cf or the neutron-induced fission of $^{239}$Pu.
