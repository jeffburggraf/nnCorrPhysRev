...
Measurements of n-n angular correlation in the SF of $^{252}$Cf, the most studied case of correlated neutron emission in fission, were also performed in the present work and show good agreement with past measurements, as seen in Fig.~\ref{fig:Cf252_us_vs_them}. 
Correlated n-n measurements have also been performed using thermal neutron induced fission of $^{235}$U, $^{233}$U, and $^{239}$Pu~\cite{Sokolov2010}.
\begin{figure}[h]
\centering
