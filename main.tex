...
For this work, this places an upper bound on $\lambda$ of $5.5\times 10^{-3}$ detected uncorrelated neutrons per pulse, which is small enough to neglect all terms on the order of $\lambda^3$ or greater in the following analysis.
...
When considering the case of $P^{\text{n-n}}_{\text{dp}}$, recall that uncorrelated n-n pairs are formed by examining pulse-pairs in this case.
For $P^{\text{n-n}}_{\text{dp}}$, an uncorrelated n-n pair occurs when there is a detected neutron in both pulses.
