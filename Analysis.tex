...
Applying the same technique to a measurement of coincident neutrons from the photodisintegration of D$_{2}$O produces a flat line as expected (see Fig.~\ref{fig:D2OCorr})
